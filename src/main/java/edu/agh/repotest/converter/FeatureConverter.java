...
public class FeatureConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Feature) {
            Feature o = (Feature) object;
            return getStringKey(o.getIdFeature());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Feature.class.getName()});
            return null;
        }
    }
}
