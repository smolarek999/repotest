...
public class TestPlanConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof TestPlan) {
            TestPlan o = (TestPlan) object;
            return getStringKey(o.getIdTestPlan());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), TestPlan.class.getName()});
            return null;
        }
    }
}
