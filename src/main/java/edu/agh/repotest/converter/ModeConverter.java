...
public class ModeConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Mode) {
            Mode o = (Mode) object;
            return getStringKey(o.getIdMode());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Mode.class.getName()});
            return null;
        }
    }
}
