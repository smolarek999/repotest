...
\begin{figure}[h]
\centerline{\includegraphics[scale=0.5]{model_kaskadowy.png}}
...
\begin{figure}[h]
\centerline{\includegraphics[scale=0.5]{water-wheel.png}}
...
\begin{figure}[h]
\centerline{\includegraphics[scale=0.5]{vmodel.png}}
\caption{Model V}
\label{fig:vmodel}
\end{figure}
...
\begin{figure}[h]
\centerline{\includegraphics[scale=0.5]{Wmodel3.JPG}}
\caption{Model W}
\label{fig:vmodel}
\end{figure}
...
\begin{figure}[h]
\centerline{\includegraphics[scale=0.5]{butterflymodel2.JPG}}
...
Tester wykonuje przypisane do niego przypadki testowe. Tester wybiera pracę z listy możliwych zadań jak również może mieć z góry przypisane zadania
